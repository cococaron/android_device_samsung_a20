...
TARGET_PREBUILT_RECOVERY_DTBO := device/samsung/a20/prebuilt/recoverydtbo

# Image
BOARD_KERNEL_BASE := 0x10000000
BOARD_KERNEL_PAGESIZE := 2048
BOARD_KERNEL_CMDLINE := androidboot.hardware=exynos7885 androidboot.selinux=permissive
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --board SRPSA16A001
BOARD_MKBOOTIMG_ARGS += --recovery_dtbo $(TARGET_PREBUILT_RECOVERY_DTBO) --header_version 1
#BOARD_MKBOOTIMG_ARGS += --os_patch_level
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/a20/bootimg.mk
